...
export const Header = () => {
  return (
    ...
    <div className="flex justify-center items-center py-3 bg-black text-white text-small gap-3">
      <p className='text-white/60 hiddem md:block  '>Streamline your systems and increase your efficiency</p>
    ...
    <div className='py-5'>
      <div className='container'>
        <div className='flex items-center justify-between'>
          <Image src={Logo} alt='Front Edge Tech Logo' height={40} width={40} />
